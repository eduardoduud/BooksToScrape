...
with DAG(    
    ...
    #Primeira tarefa 
    RodarScraping = BashOperator(bash_command="python3 /scraping.py", task_id="ExecScraping")

    #Terceira tarefa
    ImportarCSV = BashOperator(bash_command="psql -U postgres -d airflow -h localhost -p 5432 -f ./importarCSV.sh", task_id="ImportarDados")

    # Configurar a tarefa ImportarCSV para ser dependente da tarefa RodarScraping
    RodarScraping >> ImportarCSV